...
module.exports = {
    VERSION: 'v4.0.0',
    ALIVE: process.env.ALIVE || " https://i.imgur.com/AsObAg4.jpeg Hey {sender}, I'm alive \n Uptime: {uptime}",
    ...
    BOT_INFO: process.env.BOT_INFO || 'Raganork;Skl11;0;https://i.imgur.com/AsObAg4.jpeg;https://chat.whatsapp.com/HpSRCH7n1fZIt8wh8wbvek',
    RBG_KEY: process.env.RBG_KEY || '',
    ALLOWED: process.env.ALLOWED || '91,94,2',
    NOT_ALLOWED: process.env.ALLOWED || '91,94,212',
    CHATBOT: process.env.CHATBOT || 'off',
    HANDLERS: process.env.HANDLERS || '.,',
    STICKER_DATA: process.env.STICKER_DATA || "Arslan king",
    BOT_NAME: process.env.BOT_NAME || 'Arslan king',
    AUDIO_DATA: process.env.AUDIO_DATA === undefined || process.env.AUDIO_DATA === "private" ? 'Arslan king;Arslan king MD bot;https://i.imgur.com/AsObAg4.jpeg' : process.env.AUDIO_DATA,
